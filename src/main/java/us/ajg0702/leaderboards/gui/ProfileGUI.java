...
public class ProfileGUI {
    ...
    public static void open(Player viewer, OfflinePlayer target, LeaderboardPlugin plugin) {
        ...
        plugin.getScheduler().runTaskAsynchronously(() -> {
            ...
            for (int i = 0; i < categories.length; i++) {
                ...
                List<String> lore = buildProfileLore(cat, target, plugin, redisCache);
    ...
    private static List<String> buildProfileLore(LeaderboardGUI.CategoryDef cat, OfflinePlayer target,
